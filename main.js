...
class item{
    ...
    create(name){
        ...
        input.disabled=true;
        input.value=name;
        input.style="margin-bottom: 10px; font-size: 20px; width: 380px; background: white; border:none; outline:none; color: green;"
...
function check(){
    if(value1.value != ""){
        ...
        window.alert("please enter text in the input");
    }
}
